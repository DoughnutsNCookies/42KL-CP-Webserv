...
/*   Updated: 2023/03/13 20:56:20 by schuah           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../incs/HttpDeleteResponse.hpp"

HttpDeleteResponse::HttpDeleteResponse(int socket, std::string path, EuleeHand database) : _socket(socket), _path(path), _database(database) {}
